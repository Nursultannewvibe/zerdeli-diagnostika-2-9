...
/* Филиалы — одним списком: адреса встречаются в подвале, в ответах на вопросы
   ...
   head — головной; сейчас это Бухар Жырау 66, до переезда в новый офис. */
const FILIALY = [
  {ru:'Бухар Жырау 66',         kz:'Бұхар Жырау 66',        head:true},
...
ru:{
  ...
  heroLead:'Ребёнок проходит онлайн-тест дома. Вы получаете карту пробелов по темам школьной программы и приходите на разбор с педагогом в удобный филиал.',
  ctaMain:'Пройти диагностику',
  ctaSticky:'Пройти диагностику',
  ...
  faq:[
    ...
    {q:'Сколько времени занимает тест?', a:'Один предмет — от 20 до 45 минут. Полный комплект класса — примерно от полутора до двух часов. Проходить всё подряд не нужно: тесты можно разбить на несколько дней, результат по каждому сохраняется.'},
    ...
    {q:'Где проходит разбор?',           a:'В удобном для вас филиале Zerdeli — адреса всех внизу страницы. Тест ребёнок проходит онлайн из дома, приходить очно нужно только на разбор.'}
  ],
...
kz:{
  ...
  heroLead:'Бала үйде онлайн тест тапсырады. Сіз мектеп бағдарламасының тақырыптары бойынша олқылықтар картасын аласыз және өзіңізге қолайлы филиалда мұғаліммен талдауға келесіз.',
  ctaMain:'Диагностикадан өту',
  ctaSticky:'Диагностикадан өту',
  ...
  faq:[
    ...
    {q:'Тест қанша уақыт алады?',            a:'Бір пән — 20-45 минут. Сыныптың толық жинағы — шамамен бір жарым-екі сағат. Барлығын қатарынан тапсыру міндетті емес: тестерді бірнеше күнге бөлуге болады, әрқайсысының нәтижесі сақталады.'},
    ...
    {q:'Талдау қайда өтеді?',                a:'Сізге қолайлы Zerdeli филиалында — барлығының мекенжайы бет соңында. Тестті бала үйден онлайн тапсырады, орталыққа тек талдауға келу керек.'}
  ],
