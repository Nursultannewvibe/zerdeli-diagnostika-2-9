...
ru:{
  ...
  faq:[
    ...
    {q:'Где проходит разбор?',           a:'В любом удобном филиале Zerdeli: __FILIALY__. Тест — онлайн из дома, очно нужно прийти только на разбор.'}
  ],
...
kz:{
  ...
  faq:[
    ...
    {q:'Талдау қайда өтеді?',                a:'Zerdeli-дің өзіңізге қолайлы кез келген филиалында: __FILIALY__. Тест — үйден онлайн, орталыққа тек талдауға келу керек.'}
  ],
